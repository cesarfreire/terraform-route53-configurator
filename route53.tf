...
resource "aws_route53_record" "registros_mx" {
  zone_id = resource.aws_route53_zone.zona_dns.zone_id
  name    = resource.aws_route53_zone.zona_dns.name
  type    = "MX"
  ttl     = "14400"
  records = ["20 mx.a.locaweb.com.br.","20 mx.b.locaweb.com.br.","10 mx.core.locaweb.com.br.","20 mx.jk.locaweb.com.br."]
}
...
resource "aws_route53_record" "registros_txt_raiz" {
  ...
  type    = "TXT"
  ttl     = "14400"
  records = ["v=spf1 include:_spf.locaweb.com.br ?all"]
}
